				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> 6419 Buena Ventura Ave?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 6419 Buena Ventura Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>6450 Buena Tentura Ave</strong></h3>
										<ul>
											<li>3 Bed - 2 Bath</li>
								...
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>3956 Altamont Ave</strong></h3>
										<ul>
											<li>4 Bed - 2 Bath</li>
											<li>1,240 Sq Ft - 7,500 Lot</li>
											<li>Sold: 10/18/13</li>
											<li>List: $349,000 - SOLD $310,000</li>
										</ul>
									</article>
								</div>
							</div>
							<br />
							<a href="http://maxebrdi.paragonrels.com/publink/default.aspx?GUID=b4621612-fe5c-4237-8697-ee40d5780729&Report=Yes" class="image full"><img style="width: 100%;" src="images/compdata.png" /></a>
						</div>
					</section>
